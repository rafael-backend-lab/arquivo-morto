# Créditos de Imagens — Arquivo Morto

Todas as imagens utilizadas no site são de domínio público, obtidas via Wikimedia Commons.

---

## Iconografia histórica (`public/assets/archive/`)

| Arquivo | Título | Autor / Fonte | Licença |
|---|---|---|---|
| `galvanism-corpse.jpg` | *A Galvanised Corpse* | Anônimo, séc. XIX — Wellcome Collection | Domínio público |
| `aldini-portrait.jpg` | *Giovanni Aldini* | Anônimo — Wikimedia Commons | Domínio público |
...
- `galvanism-corpse.jpg` — https://upload.wikimedia.org/wikipedia/commons/c/c8/A_Galvanised_Corpse.jpg
- `aldini-portrait.jpg` — https://upload.wikimedia.org/wikipedia/commons/f/fa/Giovanni_Aldini.jpg
...
## Imagem social (OG card)

| Arquivo | Descrição |
|---|---|
| `public/arquivo-morto-share-v4.jpg` | Card 1200×630 JPEG gerado localmente; composição editorial original |
